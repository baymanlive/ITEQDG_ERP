...
uses
  ...
  unSTDI010 in '..\Common\unSTDI010.pas' {FrmSTDI010},
  unORDI170 in 'unORDI170.pas' {FrmORDI170},
  unSvr in '..\Common\unSvr.pas',
  unDAL in '..\Common\unDAL.pas',
  unSTDI051 in '..\Common\unSTDI051.pas' {FrmSTDI051},
  unORDI170_query in 'unORDI170_query.pas' {FrmORDI170_query};
...
begin
  ...
  FrmORDI170:=TFrmORDI170.Create(Application);
  FrmORDI170.Show;
end;
