...
uses
  ...
  unDLIR240_query in 'unDLIR240_query.pas' {FrmDLIR240_query},
  unSTDI040 in '..\Common\unSTDI040.pas' {FrmSTDI040},
  unDLIR240 in 'unDLIR240.pas' {FrmDLIR240},
  unDLIR240_export in 'unDLIR240_export.pas' {FrmDLIR240_export},
...
begin
  ...
  FrmDLIR240:=TFrmDLIR240.Create(Application);
  FrmDLIR240.Show;
end;
