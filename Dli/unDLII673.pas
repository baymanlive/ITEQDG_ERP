...
procedure TFrmDLII673.RefreshDS(strFilter:string);
var
  tmpSQL:string;
  Data:OleVariant;
begin
  tmpSQL:='Select * From DLI673 Where Bu='+Quotedstr(g_UInfo^.BU)+' '+strFilter;
...
procedure TFrmDLII673.FormCreate(Sender: TObject);
begin
  p_SysId:='DLI';
  p_TableName:='DLI673';
...
procedure TFrmDLII673.CDSBeforePost(DataSet: TDataSet);
