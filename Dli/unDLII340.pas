...
procedure TFrmDLII340.RefreshDS(strFilter:string);
var
  tmpSQL:string;
  Data:OleVariant;
begin
  tmpSQL:='Select * From DLI340 Where Bu='+Quotedstr(g_UInfo^.BU)+' '+strFilter
         +' Order By Custno,Adhesive,LastCode,Stkname,RC';
...
procedure TFrmDLII340.FormCreate(Sender: TObject);
begin
  p_SysId:='Dli';
  p_TableName:='DLI340';
...
procedure TFrmDLII340.CDSBeforePost(DataSet: TDataSet);
var
  tmpSQL:string;
  Data:OleVariant;
...
procedure TFrmDLII340.btn_importClick(Sender: TObject);
begin
  inherited;
