...
uses
  ...
  unDLIT600 in 'unDLIT600.pas' {FrmDLIT600},
  ...
  unDLIT600_export in 'unDLIT600_export.pas' {FrmDLIT600_export},
  unSvr in '..\Common\unSvr.pas',
  unDAL in '..\Common\unDAL.pas',
  unDLIT600_check in 'unDLIT600_check.pas' {FrmDLIT600_check};
...
begin
  ...
  FrmDLIT600:=TFrmDLIT600.Create(Application);
  FrmDLIT600.Show;
end;
