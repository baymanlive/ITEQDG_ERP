...
procedure TFrmDLII541.RefreshDS(strFilter:string);
var
  tmpSQL:string;
  Data:OleVariant;
begin
  tmpSQL:='Select * From DLI541 Where Bu='+Quotedstr(g_UInfo^.BU)+' '+strFilter;
...
procedure TFrmDLII541.FormCreate(Sender: TObject);
begin
  p_SysId:='Dli';
  p_TableName:='DLI541';
...
procedure TFrmDLII541.CDSBeforePost(DataSet: TDataSet);
var
  tmpSQL:string;
  Data:OleVariant;
...
procedure TFrmDLII541.CDSNewRecord(DataSet: TDataSet);
var
  i:Integer;
begin
