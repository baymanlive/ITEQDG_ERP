...
uses
  ...
  unDLIR140 in 'unDLIR140.pas' {FrmDLIR140},
  unDLIR140_Query in 'unDLIR140_Query.pas' {FrmDLIR140_Query},
  unAdSelect in '..\Common\unAdSelect.pas' {FrmAdSelect},
  unDLIR140_ExportXlsSelect in 'unDLIR140_ExportXlsSelect.pas' {FrmDLIR140_ExportXlsSelect},
...
begin
  ...
  FrmDLIR140:=TFrmDLIR140.Create(Application);
  FrmDLIR140.Show;
end;
