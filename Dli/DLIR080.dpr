...
uses
  ...
  unDLIR080 in 'unDLIR080.pas' {FrmDLIR080},
  unDLIR080_Query in 'unDLIR080_Query.pas' {FrmDLIR080_Query},
  unGridDesign in '..\Common\unGridDesign.pas',
  unDLIR080_detail in 'unDLIR080_detail.pas' {FrmDLIR080_detail},
...
begin
  ...
  FrmDLIR080:=TFrmDLIR080.Create(Application);
  FrmDLIR080.Show;
end;
