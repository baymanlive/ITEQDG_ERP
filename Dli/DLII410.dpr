...
uses
  ...
  unDLII410 in 'unDLII410.pas' {FrmDLII410},
  unGridDesign in '..\Common\unGridDesign.pas',
  unDLII410_indate in 'unDLII410_indate.pas' {FrmDLII410_indate},
  unDLII410_custno in 'unDLII410_custno.pas' {FrmDLII410_custno},
  unDLII410_ordlist in 'unDLII410_ordlist.pas' {FrmDLII410_ordlist},
...
begin
  ...
  FrmDLII410:=TFrmDLII410.Create(Application);
  FrmDLII410.Show;
end;
