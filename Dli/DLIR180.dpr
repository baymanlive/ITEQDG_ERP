...
uses
  ...
  unDLIR180 in 'unDLIR180.pas' {FrmDLIR180},
  unDLIR180_query in 'unDLIR180_query.pas' {FrmDLIR180_query},
  unGridDesign in '..\Common\unGridDesign.pas',
  unDLIR180_export in 'unDLIR180_export.pas' {FrmDLIR180_export},
...
begin
  ...
  FrmDLIR180:=TFrmDLIR180.Create(Application);
  FrmDLIR180.Show;
end;
