...
uses
  ...
  DynVarsEh, DB, ComCtrls, GridsEh, DBAxisGridsEh, DBGridEh, StdCtrls,
  ImgList, Buttons, ExtCtrls, DBClient;

type
  TFrmDLII430_ordlist = class(TFrmSTDI051)
    DS1: TDataSource;
    DBGridEh1: TDBGridEh;
    Label1: TLabel;
    Dtp: TDateTimePicker;
...
var
  FrmDLII430_ordlist: TFrmDLII430_ordlist;
...
procedure TFrmDLII430_ordlist.FormCreate(Sender: TObject);
begin
  inherited;
...
procedure TFrmDLII430_ordlist.FormDestroy(Sender: TObject);
begin
  inherited;
  FreeAndNil(l_CDS);
  DBGridEh1.Free;
...
procedure TFrmDLII430_ordlist.btn_queryClick(Sender: TObject);
var
  i,Cnt1,Cnt2:Integer;
  tmpSQL:string;
...
begin
  ...
  DS1.DataSet:=nil;
  try
    tmpSQL:='Select Id,Pathname,Custno From DLI430'
...
procedure TFrmDLII430_ordlist.btn_exportClick(Sender: TObject);
begin
  inherited;
