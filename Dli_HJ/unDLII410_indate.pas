...
begin
  ...
  try
    ...
    begin
      ...
      tmpStime:=tmpCDS2.FieldByName('StimeX').AsString;
      if Length(tmpStime)=0 then
         tmpStime:='00:00';

      if not tmpCDS1.Locate('Stime;Pathname',
               VarArrayOf([tmpStime,tmpSQL]),[]) then
      begin
        tmpCDS1.Append;
        ...
        tmpCDS1.FieldByName('Stime').AsString:=tmpStime;
