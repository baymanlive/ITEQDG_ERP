...
uses
  ...
  DBAxisGridsEh, DBGridEh, StdCtrls, ToolWin, unDLII040_rpt;
...
//  inherited;
exit;
  l_DLII040_rpt.StartPrint(g_MInfo^.ProcId);
end;
...
procedure TFrmDLII040.DBGridEh1GetCellParams(Sender: TObject;
