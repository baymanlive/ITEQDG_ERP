...
uses
  ...
  unMPST650_query in 'unMPST650_query.pas' {FrmMPST650_query},
  unSTDI031 in '..\Common\unSTDI031.pas' {FrmSTDI031},
  unMPST650 in 'unMPST650.pas' {FrmMPST650},
  unMPST650_pur in 'unMPST650_pur.pas' {FrmMPST650_pur},
  unSTDI050 in '..\Common\unSTDI050.pas' {FrmSTDI050},
  unMPST650_sum in 'unMPST650_sum.pas' {FrmMPST650_sum},
...
begin
  ...
  FrmMPST650:=TFrmMPST650.Create(Application);
  FrmMPST650.Show;
end;
