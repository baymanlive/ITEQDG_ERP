...
interface
uses
  Windows, Classes, SysUtils, ComCtrls, DB, DBClient, Variants,
  StrUtils, unGlobal, unCommon, unMPST070_Param;
...
type
  ...
  public
    ...
    function ExecMPS(SourceDS, DestDS: TClientDataSet;
      var OptLockAns:Boolean):Boolean; //待排資料、排程結果、作業鎖定
...
//執行排程
function TMPST070_Mps.ExecMPS(SourceDS, DestDS: TClientDataSet;
  var OptLockAns:Boolean):Boolean;
var
  i,j,tmpNum:Integer;
      ...
      begin
        ...
        begin
          ...
          begin
            ...
            //未指定,檢查F/6一天中是否超2個規格
            if VarIsNull(P^.sdate1) and
               FParam.CheckFiberOverCnt(tmpMachine, Copy(P^.materialno,2,1), tmpFiber, P^.sdate) then
            begin
              P^.sqty:=tmpSqty;
              Dispose(P1);
              Next;
