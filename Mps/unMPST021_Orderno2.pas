...
type
  TFrmMPST021_Orderno2 = class(TFrmSTDI050)
    lblorderdate: TLabel;
...
var
  FrmMPST021_Orderno2: TFrmMPST021_Orderno2;
...
procedure TFrmMPST021_Orderno2.FormCreate(Sender: TObject);
begin
  inherited;
...
procedure TFrmMPST021_Orderno2.btn_okClick(Sender: TObject);
var
  tmpSQL:string;
...
//  inherited;
  ...
  try
    tmpSQL:='exec dbo.proc_MPST021_OAO '+Quotedstr(g_UInfo^.BU)+','+
