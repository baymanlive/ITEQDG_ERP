...
uses
  ...
  unMPSR220_query in 'unMPSR220_query.pas' {FrmMPSR220_query},
  ...
  unMPSR220 in 'unMPSR220.pas' {FrmMPSR220},
  unMPSR220_export in 'unMPSR220_export.pas' {FrmMPSR220_export},
...
begin
  ...
  FrmMPSR220:=TFrmMPSR220.Create(Application);
  FrmMPSR220.Show;
end;
