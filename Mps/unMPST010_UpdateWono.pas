...
type
  TFrmMPST010_UpdateWono = class(TFrmSTDI051)
    cbb: TComboBox;
...
var
  FrmMPST010_UpdateWono: TFrmMPST010_UpdateWono;
...
procedure TFrmMPST010_UpdateWono.FormCreate(Sender: TObject);
begin
  inherited;
...
procedure TFrmMPST010_UpdateWono.btn_okClick(Sender: TObject);
var
...
begin
  ...
  try
    ...
    tmpStr:='select bu,simuver,citem,wono,orderno,orderitem,materialno,sqty,'
           +' custno,custom,custom2 from mps010 where bu='+Quotedstr(g_UInfo^.BU)
