...
uses
  ...
  unMPST100 in 'unMPST100.pas' {FrmMPST100},
  unSvr in '..\Common\unSvr.pas',
  unDAL in '..\Common\unDAL.pas',
  unSTDI033 in '..\Common\unSTDI033.pas' {FrmSTDI033},
  unMPST100_setB in 'unMPST100_setB.pas' {FrmMPST100_setB},
  unMPST100_setC in 'unMPST100_setC.pas' {FrmMPST100_setC},
  unMPST100_setE in 'unMPST100_setE.pas' {FrmMPST100_setE},
  unMPST100_setF in 'unMPST100_setF.pas' {FrmMPST100_setF},
  unMPST100_setD in 'unMPST100_setD.pas' {FrmMPST100_setD},
  unMPST100_setA in 'unMPST100_setA.pas' {FrmMPST100_setA};
...
begin
  ...
  FrmMPST100:=TFrmMPST100.Create(Application);
  FrmMPST100.Show;
end;
