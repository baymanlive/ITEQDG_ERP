...
procedure TFrmMPSI560.RefreshDS(strFilter:string);
var
  tmpSQL:string;
  Data:OleVariant;
begin
  tmpSQL:='Select * From MPS560 Where Bu='+Quotedstr(g_UInfo^.BU)+' '+strFilter
...
procedure TFrmMPSI560.FormCreate(Sender: TObject);
begin
  p_SysId:='Mps';
  p_TableName:='MPS560';
...
procedure TFrmMPSI560.CDSBeforePost(DataSet: TDataSet);
var
  tmpSQL:string;
  Data:OleVariant;
...
procedure TFrmMPSI560.CDSNewRecord(DataSet: TDataSet);
var
  i:Integer;
begin
