...
//              +'<FIELD attrname="oea04" fieldtype="string" WIDTH="100"/>'
//              +'<FIELD attrname="occ02" fieldtype="string" WIDTH="100"/>'
              +'<FIELD attrname="custno2" fieldtype="string" WIDTH="100"/>'
              +'<FIELD attrname="custname2" fieldtype="string" WIDTH="100"/>'
