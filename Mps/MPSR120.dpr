...
uses
  ...
  unMPSR120 in 'unMPSR120.pas' {FrmMPSR120},
  unMPSR120_Query in 'unMPSR120_Query.pas' {FrmMPSR120_Query},
...
begin
  ...
  FrmMPSR120:=TFrmMPSR120.Create(Application);
  FrmMPSR120.Show;
end;
