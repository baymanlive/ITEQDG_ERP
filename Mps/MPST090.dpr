...
uses
  ...
  unMPST090 in 'unMPST090.pas' {FrmMPST090},
  unGridDesign in '..\Common\unGridDesign.pas',
  unMPST090_query in 'unMPST090_query.pas' {FrmMPST090_query},
  ...
  unMPST090_Export in 'unMPST090_Export.pas' {FrmMPST090_Export};
...
begin
  ...
  FrmMPST090:=TFrmMPST090.Create(Application);
  FrmMPST090.Show;
end;
